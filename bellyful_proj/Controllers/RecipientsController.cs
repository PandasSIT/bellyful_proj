...
namespace bellyful_proj.Controllers
{
    public class RecipientsController : Controller
    {
        ...
        public RecipientsController(bellyfulContext context)
        {
            _context = context;
        }
        ...
        {
            var bellyfulContext = _context.Recipient.Include(r => r.DietaryRequirementNavigation).Include(r => r.NearestBranchNavigation).Include(r => r.ReferralReasonNavigation).Include(r => r.Referrer);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["ReferralReason"] = new SelectList(_context.ReferralReason, "ReferralReasonId", "Content");
        ...
        public async Task<IActionResult> Create([Bind("RecipientId,FirstName,LastName,AddressNumStreet,TownCity,Postcode,PhoneNumber,Email,DogOnProperty,NearestBranch,ReferralReason,OtherReferralInfo,AdultsNum,Under5ChildrenNum,_510ChildrenNum,_1117ChildrenNum,DietaryRequirement,OtherAllergyInfo,AdditionalInfo,ReferrerId,CreatedDate")] Recipient recipient)
        {
            ...
            ViewData["ReferralReason"] = new SelectList(_context.ReferralReason, "ReferralReasonId", "Content", recipient.ReferralReason);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RecipientId,FirstName,LastName,AddressNumStreet," +
            "TownCity,Postcode,PhoneNumber,Email,DogOnProperty,NearestBranch,ReferralReason,OtherReferralInfo," +
            "AdultsNum,Under5ChildrenNum,_510ChildrenNum,_1117ChildrenNum,DietaryRequirement,OtherAllergyInfo," +
            "AdditionalInfo,ReferrerId,CreatedDate")] Recipient recipient)
        {
