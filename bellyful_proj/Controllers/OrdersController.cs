...
namespace bellyful_proj.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(bellyfulContext context)
        {
            _context = context;
        }
        ...
        {
            var bellyfulContext = _context.Order.Include(o => o.DeliveryManNavigation).Include(o => o.Recipient).Include(o => o.Status);
        ...
        public async Task<IActionResult> Create([Bind("OrderId,StatusId,DeliveryMan,RecipientId,CreatedDatetime,AssignDatetime,PickupDatetime,DeliveredDatetime")] Order order)
        {
            ...
            ViewData["DeliveryMan"] = new SelectList(_context.Volunteer, "VolunteerId", "FirstName", order.DeliveryMan);
            ViewData["RecipientId"] = new SelectList(_context.Recipient, "RecipientId", "FirstName", order.RecipientId);
