...
namespace bellyful_proj_v._0._2.Controllers
{
    public class VolunteerEmergencyContactsController : Controller
    {
        ...
        public VolunteerEmergencyContactsController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        {
            var applicationDbContext = _context.VolunteerEmergencyContact.Include(v => v.Volunteer);
