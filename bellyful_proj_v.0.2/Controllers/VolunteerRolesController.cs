...
namespace bellyful_proj_v._0._2.Controllers
{
    public class VolunteerRolesController : Controller
    {
        ...
        public VolunteerRolesController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(byte id, [Bind("RoleId,RoleName")] VolunteerRole volunteerRole)
        {
        ...
        private bool VolunteerRoleExists(byte id)
        {
